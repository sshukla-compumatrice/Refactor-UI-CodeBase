		...
		this.getEffectiveAppenders = function() {
			if (appenderCache === null || appenderCacheInvalidated) {
				...
				var parentEffectiveAppenders = (isRoot || !this.getAdditivity()) ?
					...
					/*if(appenders[0] == "PopUpAppender"){
						appenders.splice(0,1);
					}*/
					//console.log("array splice 11 " +  appenders[0]);
				appenderCache = parentEffectiveAppenders.concat(appenders);
				appenderCacheInvalidated = false;
			}
			//console.log("array splice " + appenderCache);
			//console.log("array splice " + JSON.stringify(appenderCache.splice(0,1)));
