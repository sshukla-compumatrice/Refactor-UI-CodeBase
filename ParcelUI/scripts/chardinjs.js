...
/* User walkthrough tour end start */
/*$(document).ready(function () {
    ...
    function goNext() {
      if($('.carousel-inner > .item.active').is(':last-child')){
       
        $('body').chardinJs('start');
		   $('#parcelTourModal').modal('hide');
    ...
    $('#parcelTourModal').modal({
      backdrop: true,
      keyboard: false
    });

    $('#parcelTourModal').on('shown.bs.modal', function () {
      $('.carousel').carousel({
        wrap: false,
        interval: false
      });
    ...
    $("#next-button").on('click', goNext);

    $("#no-thanks, #skip-tour").on('click',function() {
      $('#parcelTourModal').modal('hide')
    });
  });*/
 
/* User walkthrough tour end code */
  ...
  (function($, window) {
    ...
    chardinJs = (function() {
     ...
     /*   overlay_layer.onclick = function() {
		  ...
		  $('#closeChardin').click(function(){
			 $('body').chardinJs('stop'); 
			   $('body').css('overflow', 'auto');
		  });
		   $('#startOver').click(function(){
			 $('#parcelTourModal').modal('show');
			    $('body').chardinJs('stop');  
		  });
