	...
	$.extend(PNotify.prototype, {
		...
		init: function(){
			...
			if (this.options.icon !== false) {
				/*
				 * EDR MODIFICATION TO ADD THE ICON TO A CONTAINER
				 * PREVIOUS: nil
				 */
				this.iconHolder = $("<div />", {"class": "ui-pnotify-icon-holder"}).prependTo(this.container);

				$("<div />", {"class": "ui-pnotify-icon"})
				.append($("<span />", {"class": this.options.icon === true ? (this.options.type === "error" ? this.styles.error_icon : (this.options.type === "info" ? this.styles.info_icon : (this.options.type === "success" ? this.styles.success_icon : this.styles.notice_icon))) : this.options.icon}))
				/*
				 * EDR MODIFICATION TO ADD THE ICON TO A CONTAINER
				 * PREVIOUS .prependTo(this.container);
				 */
				.prependTo(this.iconHolder);
			}

			// Add a title.
			/*
			 * EDR MODIFICATION TO ADD THE TEXT TO A CONTAINER
			 * PREVIOUS: nil
			 */
			this.textHolder = $("<div />", {"class": "ui-pnotify-text-holder"});
			...
			/*
			 * EDR MODIFICATION TO ADD THE ICON TO A CONTAINER
			 * PREVIOUS: .appendTo(this.container);
			 */
			.appendTo(this.textHolder);
			 ...
			 * PREVIOUS: nil
			 */
			this.container.append(this.textHolder);
