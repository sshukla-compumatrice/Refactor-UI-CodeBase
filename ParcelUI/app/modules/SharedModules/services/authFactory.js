angular.module("ParcelUI").service("AuthFactory", ["APIFactory",
    "BASEURL", "$http", "globalValues", "$rootScope", "ReportDashboardUrlCollection", "$cookieStore", "globalValues",
    function (APIFactory,
        BASEURL, $http,
        globalValues, $rootScope, ReportDashboardUrlCollection, $cookieStore, globalValues)
    {
