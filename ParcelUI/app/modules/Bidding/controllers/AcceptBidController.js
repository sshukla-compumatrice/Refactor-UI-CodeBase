...
angular.module('Bidding').controller('AcceptBidController', ['$timeout', '$scope', '$compile', '$location', '$state', 'BiddingAPI','BASEURL', 'globalValues', function ($timeout, $scope, $compile, $location, $state, BiddingAPI,BASEURL, globalValues) {
