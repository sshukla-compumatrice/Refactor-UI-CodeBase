angular.module('logEnhancingModule', []).provider('logEnhancer', function () {
    ...
    this.$get = function () {
        ...
        return {
            enhanceAngularLog: function (applicationInfoObject, environmentInfoObject, logUrls, loggingSessionGUID, $log, $http) {
                ...
                function loginServer(timestamp, level, controller, modifiedArguments, uriparams, requestid) {
                    ...
                    if (level != "debug") {
                        var staticPath = logUrls.postLogJSON;
                        ...
                        $http({
                                ...
                                data: obj,
                                headers: {
                                    'loggingSessionGUID': loggingSessionGUID == undefined ? '' : loggingSessionGUID
                                }
                            })
