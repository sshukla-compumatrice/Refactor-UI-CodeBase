angular.module('AccessManagement').service('geocodeService', ['AccessMgmtFactory', 'geocodeUrlCollection', 'BASEURL', function (AccessMgmtFactory, geocodeUrlCollection, BASEURL) {
    ...
    this.apiType = {
        ...
        geocode: {
            ...
            real: BASEURL.GEOCODE + geocodeUrlCollection.GETAPI_GEOCODE_REAL
        },
        getCountries: {
            mock: geocodeUrlCollection.GETAPI_COUNTRIES_MOCK,
            real: BASEURL.GEOCODE + geocodeUrlCollection.GETAPI_COUNTRIES_REAL
        },
        getStates: {
            mock: geocodeUrlCollection.GETAPI_STATES_MOCK,
            real: BASEURL.GEOCODE + geocodeUrlCollection.GETAPI_STATES_REAL
        },
        getCounties: {
            mock: geocodeUrlCollection.GETAPI_COUNTIES_REAL,
            real: BASEURL.GEOCODE + geocodeUrlCollection.GETAPI_COUNTIES_REAL
        }
    };
    ...
    this.geocode = function (geocodeParams) {
        ...
        return AccessMgmtFactory.get(url, queryParams);
    };
